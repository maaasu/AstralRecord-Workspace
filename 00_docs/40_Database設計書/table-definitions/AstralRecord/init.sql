...
-- ============================================================
-- AstralRecord\dbo.skilltree_definition_generation.md
-- ============================================================
...
-- ============================================================
-- AstralRecord\dbo.skilltree_server_runtime.md
-- ============================================================
CREATE TABLE [dbo].[skilltree_server_runtime] (
    ...
    CONSTRAINT [CK_skilltree_server_runtime_id] CHECK (LEN(LTRIM(RTRIM([server_id]))) > 0)
);
GO

-- ============================================================
-- AstralRecord\dbo.skilltree_server_player_view.md
-- ============================================================
...
CREATE NONCLUSTERED INDEX [IX_skilltree_server_player_view_seen]
    ON [dbo].[skilltree_server_player_view] ([last_seen_utc]);
GO

-- ============================================================
-- AstralRecord\dbo.skilltree_operation.md
-- ============================================================
