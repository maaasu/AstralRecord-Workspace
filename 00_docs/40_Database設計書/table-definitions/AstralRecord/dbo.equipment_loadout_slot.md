...
| `slot_type` | `NVARCHAR(30)` |  | ○ |  | 装備スロット種別。例: `WEAPON`, `HEAD`, `CHEST`, `SKILLBOOK`, `ACCESSORY` |
| `slot_index` | `INT` |  | ○ | `0` | `SKILLBOOK` は 0（1枠）。`ACCESSORY` は 0 = オフハンド、1 = アミュレット、2〜3 = タリスマン、4〜6 = チャーム、7 = コア、8〜9 = レリック |
