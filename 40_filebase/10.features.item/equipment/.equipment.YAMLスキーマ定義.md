...
| `equipment[].stats[].value.max`                           | String        | ×  | -     | ステータス上限値。固定値または範囲（例: `21` / `21~00`）。                                                                                                          |
...
| `equipment[].enchant.pools[].entries[].value`             | String        | ×  | -     | 付与される値。固定値または範囲（例: `0` / `3~8`）。                                                                                                               |
...
| `equipment[].enhance.levels[].statIncrease[].value`       | String        | ×  | -     | 上昇幅。固定値または範囲（例: `3` / `2~0`）。                                                                                                                  |
