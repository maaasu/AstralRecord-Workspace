...
| GET `/api/geyser/heads` | Geyser Extension 起動用のカスタムヘッドテクスチャ・未削除ユーザー UUID 一括取得 | `00_docs/20_API設計書/feature/99-system/3-エンドポイント仕様/99_3.00-索引.md` |
...
| GET `/api/account/resolve` | UUID・名称・スロット・ユーザーの選択中アカウント解決 | `00_docs/20_API設計書/feature/02-account/3-エンドポイント仕様/02_3.00-索引.md` |
| POST `/api/account/{uuid}/clone` | アカウント専用プレイヤーデータの複製・確認済み上書き | `00_docs/20_API設計書/feature/02-account/3-エンドポイント仕様/02_3.00-索引.md` |
