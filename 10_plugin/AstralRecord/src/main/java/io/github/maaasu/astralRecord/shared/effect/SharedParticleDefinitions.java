...
public final class SharedParticleDefinitions {
    ...
    public static final SharedParticleDefinition SKILL_ARCHMAGE_CELESTIAL_VIOLET =
        new SharedParticleDefinition("skill_archmage_celestial_violet", Particle.DUST, 1, 0.0D, 0.0D, 0.0D, 0.0D,
            new Particle.DustOptions(Color.fromRGB(157, 89, 255), 1.10F));
    public static final SharedParticleDefinition SKILL_ARCHMAGE_CELESTIAL_RED =
        new SharedParticleDefinition("skill_archmage_celestial_red", Particle.DUST, 1, 0.0D, 0.0D, 0.0D, 0.0D,
            new Particle.DustOptions(Color.fromRGB(255, 44, 68), 1.20F));
    ...
    public static final SharedParticleDefinition SKILL_ARCHMAGE_CLEAR_CIRCLE_CYAN =
        new SharedParticleDefinition("skill_archmage_clear_circle_cyan", Particle.DUST, 1, 0.0D, 0.0D, 0.0D, 0.0D,
            new Particle.DustOptions(Color.fromRGB(75, 220, 255), 0.8F));
    public static final SharedParticleDefinition SKILL_ARCHMAGE_CLEAR_CIRCLE_WHITE =
        new SharedParticleDefinition("skill_archmage_clear_circle_white", Particle.DUST, 1, 0.0D, 0.0D, 0.0D, 0.0D,
            new Particle.DustOptions(Color.fromRGB(220, 250, 255), 0.75F));
    public static final SharedParticleDefinition SKILL_ARCHMAGE_CLEAR_CIRCLE_GOLD =
    ...
    public static final SharedParticleDefinition FISHING_ROD_LINE =
        new SharedParticleDefinition("fishing_rod_line", Particle.DUST, 1, 0.0D, 0.0D, 0.0D, 0.0D,
            new Particle.DustOptions(Color.BLACK, 0.15F), true);
    ...
    public static final SharedParticleDefinition SKILL_PALADIN_DIVINE_CHASER_END_ROD =
        new SharedParticleDefinition(
            "skill_paladin_divine_chaser_end_rod",
            Particle.END_ROD,
            1,
            0.01D,
            0.01D,
    ...
    public static final SharedParticleDefinition SKILL_PALADIN_HOLY_SMASH_DUST =
        new SharedParticleDefinition(
            "skill_paladin_holy_smash_dust",
            Particle.DUST,
            10,
            0.035D,
            0.035D,
            0.035D,
            0.0D,
            new Particle.DustOptions(Color.WHITE, 1.45F)
        );
