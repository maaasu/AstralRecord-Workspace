...
public enum ConditionType {
    BURNING("燃焼", ConditionCategory.DOT, 100,
            effect(20, 0.01D, false, 1.0D, 1.0D, 1.0D, false, false, false, false, false, 0, 0, 0),
    ...
    POISON("毒", ConditionCategory.DOT, 120,
            effect(20, 0.03D, true, 1.0D, 1.0D, 1.0D, false, false, false, false, false, 0, 0, 0),
    ...
    BLINDNESS("盲目", ConditionCategory.CONTROL, 100,
            effect(0, 0.0D, false, 1.0D, 1.0D, 1.0D, false, false, false, false, false, 0, 0, 0),
    ...
    WEAKNESS("衰弱", ConditionCategory.AMPLIFIER, 100,
            effect(0, 0.0D, false, 1.0D, 1.0D, 0.5D, false, false, false, false, false, 0, 0, 0),
    ...
    HEALING_INHIBITION("回復阻害", ConditionCategory.AMPLIFIER, 100,
            effect(0, 0.0D, false, 1.0D, 1.0D, 1.0D, false, false, false, false, true, 0, 0, 0),
    ...
    private static @NotNull ConditionEffect effect(
        ...
        return new ConditionEffect(
                tickIntervalTicks, healthRate, currentHealthBased, 0.0D, 0.0D,
