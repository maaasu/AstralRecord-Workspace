        ...
        return List.of(
                ...
                new SkillDefinition(
                        ...
                        Map.ofEntries(
                                ...
                                Map.entry("damageType", "PHYSICAL"),
                                Map.entry("hitRange", 6.3D),
                                Map.entry("hitRadius", 0.8D),
                ...
                new SkillDefinition(
                        ...
                        Map.ofEntries(
                                ...
                                Map.entry("damageType", "MAGIC"),
                                Map.entry("hitRange", 5.6D),
                                Map.entry("hitRadius", 0.9D),
                                Map.entry("hitStepDistance", 0.7D),
                                Map.entry("maxTargets", 4),
                ...
                new SkillDefinition(
                        ...
                        Map.ofEntries(
                                ...
                                Map.entry("attackType", "MAGIC"),
                                Map.entry("damageType", "MAGIC"),
                                Map.entry("hitRange", 6.5D),
                                Map.entry("hitRadius", 1.0D),
                                Map.entry("hitStepDistance", 0.8D),
                                Map.entry("maxTargets", 5),
                                Map.entry("sound", "entity.evoker.cast_spell"),
