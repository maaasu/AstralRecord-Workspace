...
final class SpawnerPacketDisplay {
    private static final AtomicInteger NEXT_ENTITY_ID = new AtomicInteger(2_810_000);
    ...
    @NotNull
    private WrappedDataValue value(int index, @NotNull WrappedDataWatcher.Serializer serializer, @NotNull Object value) {
        return WrappedDataValue.fromWrappedValue(index, serializer, value);
    }

    @NotNull
    private WrappedDataWatcher.Serializer serializer(@NotNull Type type) {
