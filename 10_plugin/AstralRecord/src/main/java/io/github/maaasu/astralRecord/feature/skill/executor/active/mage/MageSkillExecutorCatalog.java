...
public final class MageSkillExecutorCatalog {
    ...
    public static @NotNull List<SkillExecutor> create(@NotNull ActiveSkillServices services) {
        return List.of(
                ...
                new MageFrostNovaExecutor(services),
                new MageChainLightningExecutor(services),
                new MageArcaneLanceExecutor(services),
                new MageMeteorExecutor(services),
                new MageBlinkExecutor(services),
                new MageManaBarrierExecutor(services),
                new MageElementalStormExecutor(services)
        );
    }
}
