...
public enum PlayerMsgId {
    ...
    /** 与ダメージ詳細。{0}:対象 {1}:HP {2}:Shield {3}:攻撃種別 {4}:属性 {5}:命中率 {6}:命中 {7}:回避 {8}:会心表示 */
    P_5350(5350),
    /** 与ダメージ回避。{0}:対象 {1}:命中率 {2}:命中 {3}:回避 */
    P_5351(5351),
    /** 被ダメージ詳細。{0}:攻撃元 {1}:HP {2}:Shield {3}:攻撃種別 {4}:属性 {5}:命中率 {6}:命中 {7}:回避 {8}:会心表示 */
    P_5352(5352),
    /** 被ダメージ回避。{0}:攻撃元 {1}:命中率 {2}:命中 {3}:回避 */
    P_5353(5353),
    // endregion
