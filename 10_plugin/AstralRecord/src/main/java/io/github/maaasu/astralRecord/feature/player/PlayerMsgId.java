...
public enum PlayerMsgId {
    ...
    P_5873(5873),
    /** スキルジェム購入によるレベルアップ成功を通知します。{0}: スキル名、{1}: 到達レベル */
    P_5874(5874),
    /** スキルジェム購入後のレベルアップ失敗とジェム維持を通知します。 */
    P_5875(5875),
    ...
    P_6534(6534),
    /** 受付実行者から未参加メンバーへのボス挑戦待機通知。{0}: 受付実行者、{1}: ボス表示名 */
    P_6535(6535),
    // endregion
    ...
    P_7093(7093),
    /** 受付実行者から未参加メンバーへのダンジョン挑戦待機通知。{0}: 受付実行者、{1}: ダンジョン表示名 */
    P_7094(7094),
    /** カルトグラフの緊急転送クールダウン。 */
    P_7095(7095),
    /** カルトグラフの緊急転送の注意書き。 */
