...
class MainMenuScreenViewTest extends MockBukkitTestBase {
    ...
    void groupsMenuItemsIntoPersonalSocialAndUtilityRows() {
        ...
        assertEquals(12, MainMenuScreenView.EQUIPMENT_GUI_SLOT);
        assertEquals(13, MainMenuScreenView.SKILL_BIND_SLOT);
        assertEquals(14, MainMenuScreenView.CURRENCY_SLOT);
        assertEquals(16, MainMenuScreenView.PLAYER_SETTING_SLOT);
        assertEquals(20, MainMenuScreenView.ADVENTURE_RECORD_SLOT);
        assertEquals(22, MainMenuScreenView.GUIDE_SLOT);
        assertEquals(24, MainMenuScreenView.QUEST_SLOT);
        ...
        assertEquals(42, MainMenuScreenView.TRASH_SLOT);
        ...
        assertDisplayNameContains(inventory, 14, "カレンシー");
        ...
        assertMaterial(inventory, 24, Material.MAP);
        assertDisplayNameContains(inventory, 24, "クエスト");
        ...
        assertMaterial(inventory, 42, Material.LAVA_BUCKET);
    ...
    void rendersPlayerDependentLoreFromOneContext() {
        ...
        assertLoreContains(inventory, 12, "星頭巾");
        assertLoreContains(inventory, 14, "123 G");
