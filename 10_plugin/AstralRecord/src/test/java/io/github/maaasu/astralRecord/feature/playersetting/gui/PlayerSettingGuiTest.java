...
class PlayerSettingGuiTest {
     ...
     * 検証契約: 設定項目を3行目の20〜24と4行目の29〜33へ配置し、左右枠と未使用slotは設定keyとして解決しない。
     */
    @Test
    void settingLayoutUsesInteriorPanelSlots() {
        ...
        assertEquals(33, PlayerSettingGui.OFF_HAND_DISPLAY_SLOT);
        assertEquals(
        ...
        assertEquals(
            ...
            gui.getKeyAtSlot(PlayerSettingGui.OFF_HAND_DISPLAY_SLOT)
        );
