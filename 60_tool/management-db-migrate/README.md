...
`20260917_web_credentials.sql`、`20260920_trusted_admin_browser.sql`、`20260926_donations.sql` の明示登録済み migration だけを非破壊で適用・検査する専用runnerです。ゲーム用 `db-migrate` の対象や保護条件は変更しません。
